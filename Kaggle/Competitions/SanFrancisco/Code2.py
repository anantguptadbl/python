...
for district in train['PdDistrict'].unique():
	...
	#score(forest,ground_truth, predictions)
	# We will have to loop through day1
	for dayunique in test.loc[test['PdDistrict']==district,'day1'].unique():
		test.loc[(test['PdDistrict']==district) & (test['day1']==dayunique),'status']=forest.predict(test.loc[(test['PdDistrict']==district) & (test['day1']==dayunique),['district1','day1','XYCube','Hour']])
...
resultFile.to_csv('KaggleSanFrancisco/results_1.csv',index=False)
