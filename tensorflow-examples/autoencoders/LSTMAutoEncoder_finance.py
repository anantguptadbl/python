...
a=np.array([[0.7,0.2,0.1],[0.1,0.2,0.5],[0.2,0.3,0.4],[0.4,0.4,0.4],[0.8,0.1,0.3],[0.2,0.2,0.2],[0.3,0.3,0.3],[0.3,0.4,0.5],[0.5,0.6,0.7],[0.5,0.6,0.4],[0.5,0.4,0.3],[0.5,0.6,0.6]],dtype=np.float32)
a=a.reshape(4,3,3)
step_num=4
batch_num=3
elem_num=3
